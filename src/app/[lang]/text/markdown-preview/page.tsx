...
import { content as baseContent } from "@/tools/markdown-preview/content";

const MarkdownPreviewTool = dynamic(
  () =>
    import("@/tools/markdown-preview/MarkdownPreviewTool").then((m) => ({
...
const tool = ALL_TOOLS.find((t) => t.slug === "markdown-preview")!;
