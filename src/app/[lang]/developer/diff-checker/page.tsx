...
import { content as baseContent } from "@/tools/diff-checker/content";

const DiffCheckerTool = dynamic(
  () =>
    import("@/tools/diff-checker/DiffCheckerTool").then((m) => ({
      default: m.DiffCheckerTool,
    })),
  {
    ssr: false,
    loading: () => (
...
const tool = ALL_TOOLS.find((t) => t.slug === "diff-checker")!;
