  ...
  return (
    <div className="max-w-[960px] mx-auto px-4 py-12">
      ...
      <div className="text-gray-600 dark:text-gray-400 space-y-6">
        ...
        <section>
          <h2 className="text-xl font-semibold text-gray-900 dark:text-gray-100 mb-2">General Inquiries</h2>
          <p>
            For general questions, feedback, or suggestions, please email us at{" "}
            <a href="mailto:support@finepocket.app" className="text-blue-600 dark:text-blue-400 hover:underline">
        ...
        <section>
          <h2 className="text-xl font-semibold text-gray-900 dark:text-gray-100 mb-2">Bug Reports</h2>
          <p>
        ...
        <section>
          <h2 className="text-xl font-semibold text-gray-900 dark:text-gray-100 mb-2">Feature Requests</h2>
          <p>
        ...
        <section>
          <h2 className="text-xl font-semibold text-gray-900 dark:text-gray-100 mb-2">Business & Partnerships</h2>
          <p>
        ...
        <section className="bg-gray-50 dark:bg-gray-800 rounded-xl p-6 mt-8">
          <h2 className="text-lg font-semibold text-gray-900 dark:text-gray-100 mb-2">Response Time</h2>
          <p>
