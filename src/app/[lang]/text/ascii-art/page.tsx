...
import { content as baseContent } from "@/tools/ascii-art/content";

const AsciiArtTool = dynamic(
  () =>
    import("@/tools/ascii-art/AsciiArtTool").then((m) => ({
      default: m.AsciiArtTool,
    })),
  {
    ssr: false,
    loading: () => (
...
const tool = ALL_TOOLS.find((t) => t.slug === "ascii-art")!;
