...
import { content as baseContent } from "@/tools/lorem-ipsum/content";

const LoremIpsumTool = dynamic(
  () =>
    import("@/tools/lorem-ipsum/LoremIpsumTool").then((m) => ({
      default: m.LoremIpsumTool,
    })),
  {
    ssr: false,
    loading: () => (
...
const tool = ALL_TOOLS.find((t) => t.slug === "lorem-ipsum")!;
