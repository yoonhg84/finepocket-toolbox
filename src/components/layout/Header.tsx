    ...
    <header className="sticky top-0 z-50 bg-white/80 dark:bg-gray-900/80 backdrop-blur-md border-b border-gray-200 dark:border-gray-700">
      ...
      {mobileOpen && (
        <div className="md:hidden border-t border-gray-200 dark:border-gray-700 bg-white dark:bg-gray-800 px-4 py-3">
          <p className="text-xs font-semibold text-gray-400 dark:text-gray-500 uppercase mb-2">Developer Tools</p>
          {devTools.map((t) => (
            <Link
              key={t.slug}
              href={t.href}
          ...
          <p className="text-xs font-semibold text-gray-400 dark:text-gray-500 uppercase mt-3 mb-2">Text Tools</p>
          {textTools.map((t) => (
            <Link
              key={t.slug}
              href={t.href}
          ...
          <p className="text-xs font-semibold text-gray-400 dark:text-gray-500 uppercase mt-3 mb-2">Finance & Calculators</p>
          {financeTools.map((t) => (
            <Link
              key={t.slug}
              href={t.href}
