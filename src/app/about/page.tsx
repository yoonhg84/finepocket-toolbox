...
export default function AboutPage() {
  return (
    <div className="max-w-[960px] mx-auto px-4 py-12">
      <h1 className="text-3xl font-bold text-gray-900 mb-6">About FinePocket Toolbox</h1>
      ...
      <div className="prose max-w-none text-gray-600 space-y-4">
        ...
        <h2 className="text-xl font-semibold text-gray-900 mt-8">100% Browser-Based</h2>
        <p>
        ...
        <h2 className="text-xl font-semibold text-gray-900 mt-8">No Sign-Up Required</h2>
        <p>
        ...
        <h2 className="text-xl font-semibold text-gray-900 mt-8">Free Forever</h2>
        <p>
        ...
        <h2 className="text-xl font-semibold text-gray-900 mt-8">Open Web Standards</h2>
        <p>
