  ...
  return (
    <div className="max-w-[960px] mx-auto px-4 py-6">
      ...
      <p className="text-gray-600 dark:text-gray-400 mb-6">
        {content.description}{" "}
        <span className="text-gray-400 dark:text-gray-500">Free, browser-based, no sign-up required.</span>
      </p>
      ...
      {content.useCases.length > 0 && (
        <section className="mb-8">
          <h2 className="text-xl font-semibold text-gray-900 dark:text-gray-100 mb-3">Common Use Cases</h2>
