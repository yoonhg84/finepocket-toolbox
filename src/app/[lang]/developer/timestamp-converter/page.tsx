...
import { content as baseContent } from "@/tools/timestamp-converter/content";

const TimestampConverterTool = dynamic(
  () => import("@/tools/timestamp-converter/TimestampConverterTool").then((m) => ({ default: m.TimestampConverterTool })),
  { ssr: false, loading: () => <div className="h-96 animate-pulse bg-gray-100 dark:bg-gray-700 rounded-lg" /> }
);

const tool = ALL_TOOLS.find((t) => t.slug === "timestamp-converter")!;
