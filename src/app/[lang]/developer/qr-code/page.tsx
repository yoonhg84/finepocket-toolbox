...
import { content as baseContent } from "@/tools/qr-code/content";

const QrCodeTool = dynamic(
  () => import("@/tools/qr-code/QrCodeTool").then((m) => ({ default: m.QrCodeTool })),
  { ssr: false, loading: () => <div className="h-96 animate-pulse bg-gray-100 dark:bg-gray-700 rounded-lg" /> }
);

const tool = ALL_TOOLS.find((t) => t.slug === "qr-code")!;
