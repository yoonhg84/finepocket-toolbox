...
export const ALL_TOOLS: ToolMeta[] = [
  ...
  },
  {
    ...
    icon: "#",
    relatedSlugs: ["base64", "json-formatter", "diff-checker", "password-generator"],
  },
  {
    slug: "password-generator",
    category: "developer",
    name: "Password Generator",
    shortDescription: "Generate strong random passwords and passphrases",
  ...
  },
  {
    ...
    shortDescription: "Convert Unix timestamps to dates and dates to timestamps",
    href: "/developer/timestamp-converter",
    keywords: ["unix timestamp converter", "epoch converter", "timestamp to date", "date to timestamp"],
    icon: "⏱",
    relatedSlugs: ["jwt-decoder", "hash-generator", "json-formatter"],
  },
  {
    slug: "qr-code",
    category: "developer",
    name: "QR Code Generator",
    shortDescription: "Generate QR codes from text or URLs with custom colors",
    href: "/developer/qr-code",
    keywords: ["qr code generator", "qr code maker", "qr code creator", "generate qr code"],
    icon: "QR",
  ...
  },
  {
    ...
    icon: "M↓",
    relatedSlugs: ["word-counter", "case-converter", "lorem-ipsum", "ascii-art"],
  },
  {
    slug: "ascii-art",
    category: "text",
    name: "ASCII Art Generator",
    shortDescription: "Convert text to ASCII art with multiple FIGlet-style fonts",
    href: "/text/ascii-art",
    keywords: ["ascii art generator", "text to ascii art", "figlet", "text banner generator"],
    icon: "A#",
    relatedSlugs: ["word-counter", "case-converter", "lorem-ipsum", "markdown-preview"],
  },
  {
    slug: "emoji-picker",
    category: "text",
    name: "Emoji Picker",
    shortDescription: "Browse, search, and copy emojis with one click",
    href: "/text/emoji-picker",
    keywords: ["emoji picker", "emoji keyboard", "copy emoji", "emoji search", "emoji list"],
    icon: "\u{1F60A}",
  ...
  },
  {
    ...
    shortDescription: "Spin a wheel, flip a coin, or roll dice to make random decisions",
    href: "/calculators/random-picker",
    keywords: ["random picker", "spin the wheel", "coin flip", "dice roller", "random decision maker"],
    icon: "🎲",
    hubOrder: 8,
    relatedSlugs: ["percentage-calculator", "date-calculator", "tip-calculator"],
  },
  {
