...
import { content as baseContent } from "@/tools/password-generator/content";

const PasswordGeneratorTool = dynamic(
  () => import("@/tools/password-generator/PasswordGeneratorTool").then((m) => ({ default: m.PasswordGeneratorTool })),
